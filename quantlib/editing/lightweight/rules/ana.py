...
def replace_relu_anaact(module: nn.Module, quantizer_spec: dict, noise_type: str, strategy: str):
...
def replace_linear_analinear(module: nn.Module, quantizer_spec: dict, noise_type: str, strategy: str) -> nn.Module:
...
def replace_conv2d_anaconv2d(module: nn.Module, quantizer_spec: dict, noise_type: str, strategy: str) -> nn.Module:
...
class ReplaceReLUANAActivationRule(LightweightRule):
    ...
    def __init__(self, filter_: Filter, quantizer_spec: dict, noise_type: str, strategy: str):

        replacement_fun = partial(replace_relu_anaact,
...
class ReplaceLinearANALinearRule(LightweightRule):
    ...
    def __init__(self, filter_: Filter, quantizer_spec: dict, noise_type: str, strategy: str):
        ...
        replacement_fun = partial(replace_linear_analinear,
                                  quantizer_spec = quantizer_spec,
                                  noise_type = noise_type,
                                  strategy = strategy)
...
class ReplaceConv2dANAConv2dRule(LightweightRule):
    ...
    def __init__(self, filter_: Filter, quantizer_spec: dict, noise_type: str, strategy: str):
        ...
        replacement_fun = partial(replace_conv2d_anaconv2d,
                                  quantizer_spec = quantizer_spec,
                                  noise_type = noise_type,
                                  strategy = strategy)
