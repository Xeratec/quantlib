...
class LightweightGraph(object):
    ...
    @staticmethod
    def build_nodes_list(parent_module: torch.nn.Module,
                         parent_name: str = '',
                         nodes_list: List[LightweightNode] = None,
                         leaf_types: Union[List[type], Tuple[type]] = ()):
        ...
        for name, child in parent_module.named_children():
            if len(list(child.children())) == 0 or isinstance(child, tuple(leaf_types)):
                ...
                LightweightGraph.build_nodes_list(child,
