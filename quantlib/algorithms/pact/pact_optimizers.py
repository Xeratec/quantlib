...
_PACT_CLASSES = [PACTUnsignedAct, PACTAsymmetricAct, PACTConv1d, PACTConv2d, PACTLinear]
        ...
        if rep in self._created_classes.keys():
            ...
            class PACTOptimizer(base_opt_type):
                ...
                def __init__(self, net, pact_decay, *opt_args, **opt_kwargs):
                    ...
                    learnable_clipping_params = [
                        b for n in pact_filter(net_nodes) for k, b in n.module.clipping_params.items()
                        if b.requires_grad and k != 'log_t'
                    ]
