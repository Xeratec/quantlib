...
Timer2Modules = NamedTuple('Timer2Modules', [('timer', ANATimer), ('modules', List[torch.nn.Module])])
    ...
    def __init__(self, module: torch.nn.Module, ctrl_spec: List):
        ...
        if isinstance(module, nn.DataParallel):
            ...
            ctrl_spec = copy.deepcopy(
                ctrl_spec)  # TODO: find a better workaround to avoid overwriting the original controller specifications
